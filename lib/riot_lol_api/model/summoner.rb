		...
		def games
			...
			unless response.nil?
				...
				games.each do |game|
					...
					stat = game['stats']
					tab_stats = RiotLolApi::Model::Stat.new(:ward_killed => stat['wardKilled'] || 0, :vision_wards_bought => stat['visionWardsBought'] || 0, :victory_point_total => stat['victoryPointTotal'] || 0, :unreal_kills => stat['unrealKills'] || 0, :turrets_killed => stat['turretsKilled'] || 0, :true_damage_taken => stat['trueDamageTaken'] || 0, :true_damage_dealt_to_champions => stat['trueDamageDealtToChampions'] || 0, :true_damage_dealt_player => stat['trueDamageDealtPlayer'] || 0, :triple_kills => stat['tripleKills'] || 0,:total_score_rank => stat['totalScoreRank'] || 0, :total_player_score => stat['totalPlayerScore'] || 0, :team_objective => stat['teamObjective'] || 0, :super_monster_killed => stat['superMonsterKilled'] || 0, :summon_spell2_cast => stat['summonSpell2Cast'] || 0, :summon_spell1_cast => stat['summonSpell1Cast'] || 0, :spell4_cast => stat['spell4Cast'] || 0, :spell3_cast => stat['spell3Cast'] || 0, :spell2_cast => stat['spell2Cast'] || 0, :spell1_cast => stat['spell1Cast'] || 0, :quadra_kills => stat['quadraKills'] || 0, :penta_kills => stat['pentaKills'] || 0,:objective_player_score => stat['objectivePlayerScore'] || 0,:num_items_bought => stat['numItemsBought'] || 0, :node_neutralize_assist => stat['nodeNeutralizeAssist'] || 0,:node_neutralize => stat['nodeNeutralize'] || 0,:node_capture_assist => stat['nodeCaptureAssist'] || 0, :node_capture => stat['nodeCapture'] || 0,:nexus_killed => stat['nexusKilled'] || false, :neutral_minions_killed_your_jungle => stat['neutralMinionsKilledYourJungle'] || 0,:neutral_minions_killed_enemy_jungle => stat['neutralMinionsKilledEnemyJungle'] || 0,:neutral_minions_killed => stat['neutralMinionsKilled'] || 0, :minions_denied => stat['minionsDenied'] || 0,:largest_killing_spree => stat['largestKillingSpree'],:largest_multi_kill => stat['largestMultiKill'],:legendary_items_created => stat['legendaryItemsCreated'],:largest_critical_strike => stat['largestCriticalStrike'],:killing_sprees => stat['killingSprees'] || 0, :items_purchased => stat['itemsPurchased'] || 0, :first_blood => stat['firstBlood'] || 0, :double_kills => stat['doubleKills'] || 0, :consumables_purchased => stat['consumablesPurchased'], :combat_player_score => stat['combatPlayerScore'] || 0, :champions_killed => stat['championsKilled'] || 0, :barracks_killed => stat['barracksKilled'] || 0, :total_damage_dealt_to_champions => stat['totalDamageDealtToChampions'], :gold_earned => stat['goldEarned'], :item2 => stat['item2'], :item1 => stat['item1'], :ward_placed => stat['wardPlaced'], :total_damage_taken => stat['totalDamageTaken'], :item0 => stat['item0'], :physical_damage_dealt_player => stat['physicalDamageDealtPlayer'], :total_units_healed => stat['totalUnitsHealed'], :level => stat['level'], :magic_damage_dealt_to_champions => stat['magicDamageDealtToChampions'], :magic_damage_dealt_player => stat['magicDamageDealtPlayer'], :assists => stat['assists'], :magic_damage_taken => stat['magicDamageTaken'], :num_deaths => stat['numDeaths'], :total_time_crowd_control_dealt => stat['totalTimeCrowdControlDealt'], :physical_damage_taken => stat['physicalDamageTaken'], :win => stat['win'], :team => stat['team'], :sight_wards_bought => stat['sightWardsBought'], :total_damage_dealt => stat['totalDamageDealt'], :total_heal => stat['totalHeal'], :item4 => stat['item4'], :item3 => stat['item3'], :item6 => stat['item6'], :item5 => stat['item5'], :minions_killed => stat['minionsKilled'], :time_played => stat['timePlayed'], :physical_damage_dealt_to_champions => stat['physicalDamageDealtToChampions'], :true_damage_taken => stat['trueDamageTaken'], :gold_spent => stat['goldSpent'])
